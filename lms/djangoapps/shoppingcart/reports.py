...
class Report(models.Model):
    ...
    def csv_report_row(self, item):
        """
        Given the results of the query from get_report_data, this function generates a single row of a csv.
        """
        raise NotImplementedError

    def make_report(self, report_type, filelike, start_date, end_date, start_letter=None, end_letter=None):
        """
